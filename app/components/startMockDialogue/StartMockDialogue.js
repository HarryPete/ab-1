    ...
    return(
        <div className={styles.container}>
            ...
            <div className={styles.instructions}>
                ...
                <p className={styles.instruction}>5. Once you <strong>Finish</strong> you will be redirected to review page, where you check your performance with rating and tailored improvised answer for each question</p>
